; window.CloudflareApps = window.Eager = window.CloudflareApps || window.Eager || {}; window.CloudflareApps = window.CloudflareApps || {}; CloudflareApps.siteId = "65f2bada2136796b93bad6e31ee3d321"; CloudflareApps.installs = CloudflareApps.installs || {};; (function () {
...
})();; CloudflareApps.installs["Oxyc2ItY80I5"] = { appId: "lMxPPXVOqmoE", scope: {} };; CloudflareApps.installs["Oxyc2ItY80I5"].options = { "id": "UA-29119593-1", "social": true };; if (CloudflareApps.matchPage(CloudflareApps.installs['Oxyc2ItY80I5'].URLPatterns)) { (function (i, s, o, g, r, a, m) { i['GoogleAnalyticsObject'] = r; i[r] = i[r] || function () { (i[r].q = i[r].q || []).push(arguments) }, i[r].l = 1 * new Date(); a = s.createElement(o), m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m) })(window, document, 'script', '//www.google-analytics.com/analytics.js', 'ga'); }; if (CloudflareApps.matchPage(CloudflareApps.installs['Oxyc2ItY80I5'].URLPatterns)) {
    (function () {
        var options = CloudflareApps.installs['Oxyc2ItY80I5'].options
